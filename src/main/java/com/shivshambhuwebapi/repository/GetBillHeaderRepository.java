...
public interface GetBillHeaderRepository extends JpaRepository<GetBillHeader, Integer>{
	...
	List<GetBillHeader> getBillHeadersByDateByCustByPlant(@Param("plantId")int plantId,@Param("custId") int custId,@Param("fromDate")String fromDate,@Param("toDate") String toDate);
	...
	List<GetBillHeader> getBillHeadersByDateByCust(@Param("custId") int custId,@Param("fromDate")String fromDate,@Param("toDate") String toDate);
	...
	List<GetBillHeader> getBillHeadersByDateByPlant(@Param("plantId")int plantId,@Param("fromDate")String fromDate,@Param("toDate") String toDate);
