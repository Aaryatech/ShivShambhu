...
public interface GetRmcOrdersRepo extends JpaRepository<GetRmcOrders, Integer> {
	...
	@Query(value = " SELECT t_order_detail.*,\n" + 
			...
			"\n" + 
			"FROM t_order_detail,t_order_header,m_customer,m_item_fg,m_plant,m_project,t_cust_po_header,m_uom,m_user\n" + 
			...
			"m_item_fg.uom_id=m_uom.uom_id ", nativeQuery = true)
