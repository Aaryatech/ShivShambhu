...
//3 Jan 2018
public interface RmcQuotItemDetailRepo extends JpaRepository<RmcQuotItemDetail, Integer> {
	...
	List<RmcQuotItemDetail> getRmcQuotItemDetail(@Param("itemId") int itemId);
