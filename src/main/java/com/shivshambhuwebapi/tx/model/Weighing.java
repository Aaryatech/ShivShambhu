...
public class Weighing {
	...
	public String toString() {
		return "Weighing [weighId=" + weighId + ", vehId=" + vehId + ", poklenId=" + poklenId + ", contraId=" + contraId
				+ ", contRate=" + contRate + ", quantity=" + quantity + ", photo1=" + photo1 + ", photo2=" + photo2
				+ ", remark=" + remark + ", userId=" + userId + ", date=" + date + ", vehKm=" + vehKm + ", poklenKm="
				+ poklenKm + ", delStatus=" + delStatus + ", exInt1=" + exInt1 + ", exInt2=" + exInt2 + ", exInt3="
				+ exInt3 + ", exVar1=" + exVar1 + ", exVar2=" + exVar2 + ", exVar3=" + exVar3 + ", exDate1=" + exDate1
				+ ", exDate2=" + exDate2 + ", exBool1=" + exBool1 + ", exBool2=" + exBool2 + "]";
	}
