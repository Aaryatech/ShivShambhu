...
public class GetQuotHeader {
	...
	public String toString() {
		return "GetQuotHeader [quotHeadId=" + quotHeadId + ", quotNo=" + quotNo + ", custId=" + custId + ", custName="
				+ custName + ", userId=" + userId + ", usrName=" + usrName + ", quotDate=" + quotDate + ", enqHeadId="
				+ enqHeadId + ", companyId=" + companyId + ", compName=" + compName + ", plantIds=" + plantIds
				+ ", status=" + status + ", delStatus=" + delStatus + ", quotTaxableAmt=" + quotTaxableAmt
				+ ", quotTaxAmt=" + quotTaxAmt + ", quotTotal=" + quotTotal + ", payTermId=" + payTermId + ", payTerm="
				+ payTerm + ", transportTermId=" + transportTermId + ", payTerms=" + payTerms + ", transportTerms="
				...
				+ ", projName=" + projName + ", noOfTolls=" + noOfTolls + ", tollCost=" + tollCost + ", otherCost="
				+ otherCost + ", transportCost=" + transportCost + ", exInt1=" + exInt1 + ", exInt2=" + exInt2
