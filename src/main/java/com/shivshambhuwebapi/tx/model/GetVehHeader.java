...
public class GetVehHeader {
	...
	public String toString() {
		return "GetVehHeader [matVehHeaderId=" + matVehHeaderId + ", vehNo=" + vehNo + ", vehId=" + vehId + ", date="
				...
				+ vehicleName + ", vehCompName=" + vehCompName + ", vehDetailList=" + vehDetailList + "]";
	}
