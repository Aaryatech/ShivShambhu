...
@Entity
public class GetMatIssueReport {
	...
	public String toString() {
		return "GetMatIssueReport [matHeaderId=" + matHeaderId + ", issueNo=" + issueNo + ", contrId=" + contrId
				...
				+ ", contrMob=" + contrMob + ", weighContrQty=" + weighContrQty + "]";
	}
