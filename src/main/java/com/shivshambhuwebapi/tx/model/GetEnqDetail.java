...
public class GetEnqDetail {
	...
	public String toString() {
		return "GetEnqDetail [enqDetailId=" + enqDetailId + ", enqHeadId=" + enqHeadId + ", itemId=" + itemId
				...
				+ ", exBool3=" + exBool3 + ", enqUomId=" + enqUomId + ", enqDRemark=" + enqDRemark + ", itemName="
				+ itemName + ", itemCode=" + itemCode + ", uomName=" + uomName + "]";
	}
