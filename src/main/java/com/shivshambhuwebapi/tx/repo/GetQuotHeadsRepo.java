...
public interface GetQuotHeadsRepo extends JpaRepository<GetQuotHeads, Integer> {
	...
	@Query(value = " SELECT t_quot_header.quot_head_id,t_quot_header.quot_no,t_quot_header.quot_date,t_quot_header.status, " + 
			" m_customer.cust_name,m_company.comp_name,m_plant.plant_name,t_enq_header.enq_no, m_user.usr_name " + 
