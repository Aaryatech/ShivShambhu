...
public interface GetPayRecoveryHeadRepo extends JpaRepository<GetPayRecoveryHead, Integer> {
  ...
  //********************Payment Recovery Done************************//
    ...
    List<GetPayRecoveryHead> getPayRecDoneBetDatePlantId(@Param("fromDate") String fromDate, @Param("toDate") String toDate,
            @Param("plantId") int plantId);
    ...
    List<GetPayRecoveryHead> getPayRecDoneBetDatePlantIdCustId(@Param("fromDate") String fromDate, @Param("toDate") String toDate,
    ...
    List<GetPayRecoveryHead> getPayRecBetDateSpecCust(@Param("fromDate") String fromDate, @Param("toDate") String toDate,
