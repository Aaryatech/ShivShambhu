package com.shivshambhuwebapi.model.rmc;
...
public class GetRmcOrders {
	...
	public String getProjPerMob() {
		return projPerMob;
	}

	public void setProjPerMob(String projPerMob) {
		this.projPerMob = projPerMob;
	}

	public String getProjPerName() {
		return projPerName;
	}

	public void setProjPerName(String projPerName) {
		this.projPerName = projPerName;
	}
	...
	public String toString() {
		return "GetRmcOrders [orderDetId=" + orderDetId + ", orderId=" + orderId + ", poId=" + poId + ", itemId="
				...
				+ ", exBool2=" + exBool2 + ", exBool3=" + exBool3 + ", status=" + status + ", plantId=" + plantId
				+ ", custId=" + custId + ", projId=" + projId + ", deliveryDate=" + deliveryDate + ", orderDate="
				+ orderDate + ", prodDate=" + prodDate + ", orderNo=" + orderNo + ", dispatchTime=" + dispatchTime
