...
public class ProdPlanDetail {
	...
	public String toString() {
		return "ProdPlanDetail [productionDetailId=" + productionDetailId + ", productionHeaderId=" + productionHeaderId
				...
				+ productionQty + ", rejectedQty=" + rejectedQty + ", productionBatch=" + productionBatch + ", status="
				+ status + ", delStatus=" + delStatus + ", exInt1=" + exInt1 + ", exInt2=" + exInt2 + ", boolean1="
				+ boolean1 + ", boolean2=" + boolean2 + ", boolean3=" + boolean3 + ", boolean4=" + boolean4
				+ ", boolean5=" + boolean5 + ", exVar1=" + exVar1 + ", exVar2=" + exVar2 + ", exVar3=" + exVar3
				+ ", exVar4=" + exVar4 + "]";
	}
