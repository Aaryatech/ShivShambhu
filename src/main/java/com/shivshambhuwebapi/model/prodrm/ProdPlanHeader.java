...
public class ProdPlanHeader {
	...
	public String toString() {
		return "ProdPlanHeader [productionHeaderId=" + productionHeaderId + ", productionDate=" + productionDate
				...
				+ ", prodPlanDetailList=" + prodPlanDetailList + ", getExInt1()=" + getExInt1() + ", getExInt2()="
				+ getExInt2() + ", getExVar1()=" + getExVar1() + ", getExVar2()=" + getExVar2() + ", getExVar3()="
				+ getExVar3() + ", getProdPlanDetailList()=" + getProdPlanDetailList() + ", getProductionHeaderId()="
				+ getProductionHeaderId() + ", getProductionDate()=" + getProductionDate() + ", getProductionBatch()="
				+ getProductionBatch() + ", getPlantId()=" + getPlantId() + ", getProductionStatus()="
				+ getProductionStatus() + ", getDelStatus()=" + getDelStatus() + ", getSubPlantId()=" + getSubPlantId()
				+ ", getProductionStartDate()=" + getProductionStartDate() + ", getProductionEndDate()="
				+ getProductionEndDate() + ", getUserId()=" + getUserId() + ", getClass()=" + getClass()
