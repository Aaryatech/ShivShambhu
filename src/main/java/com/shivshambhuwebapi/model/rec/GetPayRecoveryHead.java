...
@Entity
public class GetPayRecoveryHead {
	...
	public String toString() {
		return "GetPayRecoveryHead [payHeadId=" + payHeadId + ", billNo=" + billNo + ", billHeadId=" + billHeadId
				...
				+ exBool1 + ", exBool2=" + exBool2 + ", custName=" + custName + ", custMobNo=" + custMobNo
				+ ", payRecoveryDetailList=" + payRecoveryDetailList + "]";
	}
