...
public class GetItemTax {
	...
	public String toString() {
		return "GetItemTax [itemId=" + itemId + ", itemName=" + itemName + ", itemCode=" + itemCode + ", itemImage="
				...
				+ ", hsnCode=" + hsnCode + ", uomName=" + uomName + ", plantName=" + plantName + ", igst=" + igst
				+ ", cgst=" + cgst + ", cess=" + cess + ", sgst=" + sgst + "]";
	}
