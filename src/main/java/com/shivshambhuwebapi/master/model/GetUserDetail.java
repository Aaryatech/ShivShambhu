...
public class GetUserDetail {
	...
	public String toString() {
		return "GetUserDetail [userId=" + userId + ", usrName=" + usrName + ", userPass=" + userPass + ", usrMob="
				+ usrMob + ", deptId=" + deptId + ", companyId=" + companyId + ", plantId=" + plantId + ", usrEmail="
				+ usrEmail + ", usrDob=" + usrDob + ", roleId=" + roleId + ", sortNo=" + sortNo + ", delStatus="
				+ delStatus + ", deviceToken=" + deviceToken + ", exInt1=" + exInt1 + ", exInt2=" + exInt2 + ", exVar1="
				+ exVar1 + ", exVar2=" + exVar2 + ", exDate1=" + exDate1 + ", exDate2=" + exDate2 + ", deptName="
