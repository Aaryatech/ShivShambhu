...
public class GetPlant {
	...
	public String toString() {
		return "GetPlant [plantId=" + plantId + ", compName=" + compName + ", plantName=" + plantName + ", companyId="
				+ companyId + ", plantAddress1=" + plantAddress1 + ", plantAddress2=" + plantAddress2
				+ ", plantContactNo1=" + plantContactNo1 + ", plantContactNo2=" + plantContactNo2 + ", plantFax1="
				+ plantFax1 + ", plantFax2=" + plantFax2 + ", plantHead=" + plantHead + ", plantEmail1=" + plantEmail1
				+ ", plantEmail2=" + plantEmail2 + ", isUsed=" + isUsed + ", delStatus=" + delStatus + ", exInt1="
